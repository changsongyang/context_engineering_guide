...
| Anthropic Claude 系列 | 当前快照记录 Claude Fable 5 已恢复全球访问；Mythos 5 非普遍可用，仅通过 Project Glasswing 向获批客户受限开放（2026-07-01 先恢复给一组美国机构）；并收录面向所有套餐和 API 发布的 Claude Sonnet 5 与 2026-07-24 发布的 Claude Opus 5（官方模型页把 Opus 4.8/4.7/4.6 与 Sonnet 4.6 列入 legacy） | 长文理解、代码与写作稳定性 | 同时核验能力规格、访问状态、区域路由、缓存、批处理和实际账号可用区 |
